...
namespace StarWars
{
    ...
    public class MyThread : IActionQueue
    {
        public MyThread()
        {
            InitThread(new AsyncActionProcessor());
        }
        ...
        public MyThread(AsyncActionProcessor asyncActionQueue)
        {
            InitThread(asyncActionQueue);
        }
        public MyThread(int tickSleepTime, AsyncActionProcessor asyncActionQueue)
        {
            m_TickSleepTime = tickSleepTime;
            InitThread(asyncActionQueue);
        }
        public MyThread(int tickSleepTime, int actionNumPerTick, AsyncActionProcessor asyncActionQueue)
        {
            m_TickSleepTime = tickSleepTime;
            m_ActionNumPerTick = actionNumPerTick;
            InitThread(asyncActionQueue);
        ...
        private void InitThread(AsyncActionProcessor asyncActionQueue)
        {
